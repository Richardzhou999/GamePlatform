...
class GameAdapter : BaseEmptyViewAdapter<GamesEntity>{

    private var context : Context? = null


    constructor(context: Context, layoutResId: Int, list: ArrayList<GamesEntity>) :
    ...
    override fun convert(holder: BaseViewHolder?, entity: GamesEntity?) {
        ...
        var relativeLayout = holder!!.getView<View>(R.id.game_item_layout)
