 ...
 */
public class MainMetroViewBorderHandler implements IMetroViewBorder {

    private String TAG = MainMetroViewBorderHandler.class.getSimpleName();
    ...
    public MainMetroViewBorderHandler() {
