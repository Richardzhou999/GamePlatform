...
import com.unis.gameplatfrom.utils.AnimationUtil;
...
public class AdapterMetroView extends RelativeLayout {
    ...
    protected void init(Context context, AttributeSet attrs) {
        ...
        if (mDrawable == null) {
            mDrawable = getResources().getDrawable(R.drawable.border_color);
        }
    ...
    protected void onFocusChanged(boolean gainFocus, int direction, Rect previouslyFocusedRect) {
        ...
        LinearLayout linearLayout = getRootView().findViewById(R.id.lin_progress);
        int visibility = linearLayout.getVisibility();
        if (linearLayout != null && visibility == View.GONE) {

            if (gainFocus) {
                bringToFront();
                getRootView().invalidate();
                if (hasAnim) {
                    scaleAnimation = AnimationUtil.startScaleToBigAnimation(this, SCALE_RATE, new AnimatorListener() {
                ...
                if (hasAnim) {
                    scaleAnimation = AnimationUtil.startScaleToSmallAnimation(this, SCALE_RATE, null);
                }
            }
        }else {
