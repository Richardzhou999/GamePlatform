...
/**
 * Created by wulei on 2017/4/6.
 */

@SuppressWarnings("DefaultFileTemplate")
public abstract class BaseRefreshActivity extends BaseActivity implements IRefresh {
    ...
    private void initRefreshLayout() {
        ...
        mRefreshLayout.setOnRefreshListener(refreshlayout -> {
            ...
            page = 1;
            BaseRefreshActivity.this.onRefresh((View) refreshlayout);
        });

        mRefreshLayout.setOnLoadmoreListener(refreshlayout -> {
            operateState = OPERATE_LOADMORE;
            page++;
            BaseRefreshActivity.this.onLoadMore((View) refreshlayout);
        });
    }
